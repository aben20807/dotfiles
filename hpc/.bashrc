...
alias seqd="echo -n '在線人數:  ';w | grep pohsuan | wc -l;echo '----squeue----';squeue -o '%.6i %.20j %.5y %.3t %.4D %.20E %.12M %.20R %.10b %.40Z';echo '----sinfo----';sinfo --exact -O 'PARTITION:13,Available:8,Nodes:6,NodeAddr:20,StateComplete,GresUsed:12,CPUsState,CPUsLoad'"
